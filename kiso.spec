...
KIso to graficzny interfejs użytkownika dla KDE, którego celem jest
uczynienie tak łatwym jak to tylko możliwe:
- otwierania obrazów ISO i NRG
- tworzenia obrazów ISO z CD
- tworzenia własnych obrazów ISO
...
- wyciągania zawartości z obrazów ISO/NRG
